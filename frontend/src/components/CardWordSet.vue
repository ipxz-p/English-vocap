<template>
    <router-link :to="{name: toName, params: {id} }" class="cursor-pointer border-2 border-yellow-400 rounded-lg px-4 py-3 bg-yellow-100">
...
import { Menu, MenuButton, MenuItems, MenuItem } from '@headlessui/vue'
    export default {
        props: ['id', 'name', 'description', 'total_word', 'total_play', 'toName', 'username'],
        components: {
            Menu,
            MenuButton,
            MenuItems,
