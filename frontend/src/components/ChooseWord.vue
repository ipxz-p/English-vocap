<template>
    <div class="m-5">
        ...
        <div class="flex flex-col gap-4">
            <span class="animate-flash text-2xl font-extrabold text-mypink-400 mt-2">My word</span>
        </div>
        ...
        <div class="flex flex-col gap-4">
            <span class="animate-flash text-2xl font-extrabold text-mypink-400 mt-2">Other word</span>
        </div>
