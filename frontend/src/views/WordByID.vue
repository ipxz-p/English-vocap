<template>
    <div class="m-5">
        <div class="flex items-center justify-between font-semibold">
            ...
            <button @click="setPopup('addWord')" class="px-4 py-2 bg-mypink-300 rounded-lg text-white flex items-center">
            ...
            <template v-slot:item.actions="{ item }">
                <div class="flex gap-3">
                    <div
                        ...
                        @click="setPopup('editWord'), setWord(item)"
                    >
                    ...
                    <div
                        ...
                        @click="setPopup('deleteWord'), setWord(item)"
                    >
        ...
        <Popup type="addWord" v-if="this.$store.state.showPopup && this.$store.state.typePopup === 'addWord'">
            ...
            <div @click.stop="">
                ...
                <div class="mt-4">
                    ...
                    <button @click="addWord()" class="w-full bg-mypink-300 text-white py-2 mt-4 rounded-xl" type="submit">Add</button>
            </div>
        </Popup>
        <!-- popup edit word -->
        <Popup type="editWord" v-if="this.$store.state.showPopup && this.$store.state.typePopup === 'editWord'">
            ...
            <div @click.stop="">
                ...
                <div class="mt-4">
                    ...
                    <button @click="editWord()" class="w-full bg-mypink-300 text-white py-2 mt-4 rounded-xl" type="submit">Edit</button>
            </div>
        </Popup>
        ...
        <Popup type="deleteWord" v-if="this.$store.state.showPopup && this.$store.state.typePopup === 'deleteWord'">
            ...
            <div @click.stop="">
                ...
                <div class="flex">
                    <button @click="setPopup('deleteWord')" class="w-full py-2 mt-4 rounded-xl" type="submit">Cancel</button>
                    <button @click="deleteWord()" class="w-full bg-red-600 text-white py-2 mt-4 flex items-center justify-center rounded-xl" type="submit">
        ...
        data: () => ({
            ...
            methods: {
                setWord(item){
                    ...
                    this.type = Object.assign({}, item.raw).type
